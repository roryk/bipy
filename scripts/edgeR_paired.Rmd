...
```{r variables}
wd = '/Users/rory/cache/bipy/scripts/'
setwd(wd)
infile = paste(wd, '../test/data/counts/control_vs_exposed.counts.txt', sep="")
...
testing.__
```{r model, echo=TRUE}
conditions = data.frame(id = c("Pb8", "Pb2", "Pb21", "Pb11", "Pb5", "Pb22"),
	treatment = c("control", "control", "control", "exposed", "exposed", "exposed"),
	trial = c(2, 1, 3, 2, 1, 3))
